...
export function ModeratePostModal({
  ...
  return (
    <div className="fixed inset-0 bg-neutral-900/20 dark:bg-neutral-900/80 backdrop-blur-sm flex items-center justify-center z-[70] p-4 animate-fade-in">
      <div className="bg-white dark:bg-neutral-900 w-full max-w-lg p-6 shadow-2xl rounded-3xl transform animate-scale-in border border-neutral-200 dark:border-neutral-800">
        <div className="flex items-center gap-4 mb-6">
          <div
        ...
        <div className="space-y-4 mb-6">
          <textarea
            ...
            className="w-full min-h-[120px] p-4 bg-neutral-50 dark:bg-neutral-800/50 rounded-2xl border border-neutral-200 dark:border-neutral-700 focus:ring-2 focus:ring-neutral-200 dark:focus:ring-neutral-700 focus:border-transparent outline-none text-sm font-medium resize-none transition-all"
          />
        </div>
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`flex-1 py-3 rounded-xl font-bold text-white shadow-lg transition-all flex items-center justify-center gap-2 text-sm ${
              isHide
                ? 'bg-amber-600 hover:bg-amber-700 shadow-amber-600/20 disabled:bg-amber-400'
                : 'bg-emerald-600 hover:bg-emerald-700 shadow-emerald-600/20 disabled:bg-emerald-400'
            }`}
          >
...
export function PostReportsModal({ isOpen, onClose, reports }) {
  ...
  return (
    <div className="fixed inset-0 bg-neutral-900/20 dark:bg-neutral-900/80 backdrop-blur-sm flex items-center justify-center z-[70] p-4 animate-fade-in">
      <div className="bg-white dark:bg-neutral-900 w-full max-w-2xl max-h-[80vh] flex flex-col shadow-2xl rounded-3xl transform animate-scale-in border border-neutral-200 dark:border-neutral-800 overflow-hidden">
        ...
        <div className="p-6 overflow-y-auto space-y-4">
          {reports?.length > 0 ? (
            reports.map(report => (
              <div
                key={report._id}
                className="p-5 border border-neutral-200 dark:border-neutral-800 rounded-2xl bg-neutral-50/50 dark:bg-neutral-800/30"
              >
                <div className="flex justify-between items-center mb-3">
                  <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-rose-100 dark:bg-rose-900/30 text-rose-700 dark:text-rose-400 border border-rose-200 dark:border-rose-800">
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-neutral-200 dark:border-neutral-700/50">
                  <img
                    src={
        ...
        <div className="p-6 border-t border-neutral-100 dark:border-neutral-800 bg-neutral-50/50 dark:bg-neutral-800/30">
          <button
            onClick={onClose}
            className="w-full py-3 rounded-xl font-bold bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-50 dark:hover:bg-neutral-700 transition-colors text-sm shadow-sm"
          >
            Đóng danh sách
          </button>
        </div>
